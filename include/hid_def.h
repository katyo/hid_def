...
#define HID_UNIT_EXPONENT(n, x) HID_ELEM(0x5, GLOBAL, n, x)

#define HID_UNIT_SYSTEM      0x00

#define HID_UNIT_SI_LINEAR   0x10
#define HID_UNIT_SI_ROTATION 0x20
#define HID_UNIT_EN_LINEAR   0x30
#define HID_UNIT_EN_ROTATION 0x40

#define HID_UNIT_LENGTH      0x01
#define HID_UNIT_MASS        0x02
#define HID_UNIT_TIME        0x03
#define HID_UNIT_TEMPERATURE 0x04
#define HID_UNIT_CURRENT     0x05
#define HID_UNIT_LUMINOSITY  0x06
#define HID_UNIT_RESERVED    0x07

#define HID_UNIT_CENTIMETER (HID_UNIT_SI_LINEAR | HID_UNIT_LENGTH)
#define HID_UNIT_GRAM       (HID_UNIT_SI_LINEAR | HID_UNIT_MASS)
#define HID_UNIT_SECOND     (HID_UNIT_SI_LINEAR | HID_UNIT_TIME)
#define HID_UNIT_KELVIN     (HID_UNIT_SI_LINEAR | HID_UNIT_TEMPERATURE)
#define HID_UNIT_AMPERE     (HID_UNIT_SI_LINEAR | HID_UNIT_CURRENT)
#define HID_UNIT_CANDELLA   (HID_UNIT_SI_LINEAR | HID_UNIT_LUMINOSITY)
#define HID_UNIT_RADIANS    (HID_UNIT_SI_ROTATION | HID_UNIT_LENGTH)
#define HID_UNIT_INCH       (HID_UNIT_EN_LINEAR | HID_UNIT_LENGTH)
#define HID_UNIT_SLUG       (HID_UNIT_EN_LINEAR | HID_UNIT_MASS)
#define HID_UNIT_FAHRENHEIT (HID_UNIT_EN_LINEAR | HID_UNIT_TEMPERATURE)
#define HID_UNIT_DEGREES    (HID_UNIT_EN_ROTATION | HID_UNIT_LENGTH)

/* TODO: Complete unit definition */
#define HID_UNIT(n, unit) HID_ELEM(0x6, GLOBAL, n, _CAT2(HID_UNIT_, unit))
